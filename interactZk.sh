...
TOKEN_ADDRESS=$(forge create src/Sarpaine.sol:Sarpaine --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync --broadcast | awk '/Deployed to:/ {print $3}' )
